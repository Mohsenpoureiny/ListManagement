...
namespace ListManagement.services
{
    public class ItemService
    {
        ...
        private ItemService()
        {
            ...
            persistencePath = $"{Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\\SaveData_1.json";
        ...
        public void DoneIt(Item i)
        {
            var itm = (items[items.IndexOf(i)] as ToDo);
            itm.IsCompleted = true;
            items[items.IndexOf(i)] = itm;
        }
